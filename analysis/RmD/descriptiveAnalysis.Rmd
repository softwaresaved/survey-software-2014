...
data_cleaned<-read.csv("SurveyDataCleaned.csv", stringsAsFactors=TRUE, na.strings="")
...
g_legend<-function(a.gplot){
    ...
    return(legend)}
for (i in c('Q.1.Institution', 'Q.3.Discipline', 'Q.4.Funds_cleaned', 'Q.5.Seniority', 'Q.6.Use_software', 'Q.7.Importance_software',
            'Q.8.Developing_software', 'Q.10.Cost_software', 'E.1.Job_cleaned', 'E.2.Gender', 'E.3.Contract', 'E.4.OS'))
    {
    ...
    #stargazer(QSummary, title=i, type='html', summary=FALSE, style='aer', column.sep.width='10')
    ...
    #g2 <- g2 + scale_y_continuous(limits=c(min(QSummary$`Total Respondant`), max(QSummary$`Total Respondant`)))
