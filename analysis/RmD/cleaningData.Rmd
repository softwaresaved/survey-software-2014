...
Renames the titles of the Question to something easier to use in the code. Also help to have easier name of references.

```{r}

#names(data) <- c('I.Timestamp', 'Q.1.Institution', 'Q.2.Role', 'Q.3.Discipline', 'Q.4.Funds', 
 #                   'Q.5.Seniority', 'Q.6.Use_software', 'Q.7.Importance_software',
    #                'Q.8.Developing_software', 'Q.9.Training', 'Q.10.Cost_software',
  #                  'Q.11.Main_software', 'E.1.Job_title', 'E.2.Gender', 'E.3.Contract',
   #                 'E.4.OS', 'I.Id')
```

```{r}

	#New column for Extra Question 1
	#df$E.1.Job_cleaned<-NA
```
