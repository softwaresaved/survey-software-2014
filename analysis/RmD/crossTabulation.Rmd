...
```{r fig.width=20, fig.height=10, echo=FALSE}
	...
	sumQ  <-  singleTabFreq(dfYES[which(dfYES$Q.8.Developing.Software == 'Yes'),]$Q.9.Clean, 'Training in Software development')
	kable(sumQ, digits=2)
	plotSingleFreq(sumQ, 'Training in Software development', ownColour=color_Developing)
...
```{r fig.width=20, fig.height=10, echo=FALSE}
	sumQ  <- crossTabFreq(dfYES, 'Q.3.Modified.Disciplines', 'Q.9.Clean') 
	facetPlot(sumQ, facetVar='Q.3.Modified.Disciplines', xVar='Q.9.Clean')
...
```{r fig.width=20, fig.height=10, echo=FALSE}
	sumQ  <- crossTabFreq(dfYES, 'Q.4.Modified_Funds', 'Q.7.Essential.Software') 
	facetPlot(sumQ, facetVar='Q.4.Modified_Funds', xVar='Q.7.Essential.Software')

```

### 3.2.2. Developing software per funding origin 
```{r fig.width=20, fig.height=10, echo=FALSE}
	sumQ  <- crossTabFreq(dfYES, 'Q.4.Modified_Funds', 'Q.8.Developing.Software') 
	facetPlot(sumQ, facetVar='Q.4.Modified_Funds', xVar='Q.8.Developing.Software')
...
```{r fig.width=20, fig.height=10, echo=FALSE}
	sumQ  <- crossTabFreq(dfYES, 'E.1.Job_cleaned', 'Q.7.Essential.Software') 
	facetPlot(sumQ, facetVar='E.1.Job_cleaned', xVar='Q.7.Essential.Software')
```

### 3.4.2. Developing software per Job Title

```{r fig.width=20, fig.height=10, echo=FALSE}
	sumQ  <- crossTabFreq(dfYES, 'E.1.Job_cleaned', 'Q.8.Developing.Software') 
	facetPlot(sumQ, facetVar='E.1.Job_cleaned', xVar='Q.8.Developing.Software')
```
...
```{r fig.width=20, fig.height=10, echo=FALSE}
	sumQ  <- crossTabFreq(dfYES, 'E.2.GenderCleaned', 'Q.7.Essential.Software') 
	facetPlot(sumQ, facetVar='E.2.GenderCleaned', xVar='Q.7.Essential.Software')
```

### 3.5.2. Developing software per Gender

```{r fig.width=20, fig.height=10, echo=FALSE}
	sumQ  <- crossTabFreq(dfYES, 'E.2.GenderCleaned', 'Q.8.Developing.Software') 
	facetPlot(sumQ, facetVar='E.2.GenderCleaned', xVar='Q.8.Developing.Software')
```
...
```{r fig.width=20, fig.height=10, echo=FALSE}
	sumQ  <- crossTabFreq(dfYES, 'E.4.OS_cleaned', 'Q.7.Essential.Software') 
	facetPlot(sumQ, facetVar='E.4.OS_cleaned', xVar='Q.7.Essential.Software')
```

### 3.6.2. Developing software per Operating System

```{r fig.width=20, fig.height=10, echo=FALSE}
	sumQ  <- crossTabFreq(dfYES, 'E.4.OS_cleaned', 'Q.8.Developing.Software') 
	facetPlot(sumQ, facetVar='E.4.OS_cleaned', xVar='Q.8.Developing.Software')
```
